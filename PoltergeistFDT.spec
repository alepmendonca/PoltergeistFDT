...
a = Analysis(
    ...
    datas=[('resources', 'resources'), ('mysqldump', 'mysqldump'), ('wkhtmltopdf', 'wkhtmltopdf'), ('efd-pva-inspector/bin', 'efd-pva-inspector'), ('venv/Lib/site-packages/autoit/lib/*', 'autoit/lib')],
